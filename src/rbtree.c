...
__fly_unused static inline void fly_rb_swap(fly_rb_tree_t *tree, struct fly_rb_node *dist, struct fly_rb_node *src)
{
...
__fly_unused static inline struct fly_rb_node *fly_rb_sibling(struct fly_rb_node *node)
{
