...
async def fly_server(fly_remove_pid, remove_already_in_use):
    process = await asyncio.create_subprocess_shell("python3 -m fly tests/fly_test.py -c tests/http_test.conf")
...
async def fly_mini_server(fly_remove_pid, remove_already_in_use):
    process = await asyncio.create_subprocess_shell("python3 -m fly tests/fly_test.py -c tests/http_test_mini.conf")
    await asyncio.sleep(1.5)
    yield process
    process.send_signal(SIGINT)
...
async def fly_mini_server_d(fly_remove_pid, remove_already_in_use):
    await asyncio.create_subprocess_shell("python3 -m fly tests/fly_test.py -c tests/http_test_mini.conf --daemon")
    await asyncio.sleep(1.5)
...
async def fly_server_ssl(fly_remove_pid, remove_already_in_use):
    process = await asyncio.create_subprocess_shell("python3 -m fly tests/fly_test.py -c tests/https_test.conf")
    await asyncio.sleep(1.5)
    yield process
    process.send_signal(SIGINT)
...
async def fly_server_ssl_d(fly_remove_pid, remove_already_in_use):
    await asyncio.create_subprocess_shell("python3 -m fly tests/fly_test.py -c tests/https_test.conf --daemon")
    await asyncio.sleep(1.5)
...
async def fly_mini_server_ssl(fly_remove_pid, remove_already_in_use):
    process = await asyncio.create_subprocess_shell("python3 -m fly tests/fly_test.py -c tests/https_test_mini.conf")
    await asyncio.sleep(1.5)
    yield process
    process.send_signal(SIGINT)
...
async def fly_mini_server_ssl_d(fly_remove_pid, remove_already_in_use):
    await asyncio.create_subprocess_shell("python3 -m fly tests/fly_test.py -c tests/https_test_mini.conf --daemon")
    await asyncio.sleep(1.5)
...
async def fly_server_over_worker(fly_remove_pid, remove_already_in_use):
    process = await asyncio.create_subprocess_shell("python3 -m fly tests/fly_test.py -c tests/http_test_over.conf")
    await asyncio.sleep(1.5)
    yield process
...
async def fly_server_over_worker_d(fly_remove_pid, remove_already_in_use):
    process = await asyncio.create_subprocess_shell("python3 -m fly tests/fly_test.py -c tests/http_test_over.conf --daemon")
    await asyncio.sleep(1.5)
    yield process
